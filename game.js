...
const $team1Lives = document.getElementById('team2Lives');
        ...
        game.GameView = (function () {
            ...
            GameView.prototype.setButtons = function (status) {
                ...
                if (status === GameApi.GameStatus.canceled || status === GameApi.GameStatus.finished) {
                    ...
                    utils.addClasses($btnConnectThiel, 'hidden');
                ...
                if (
                    ...
                    if (connected) {
                        ...
                        utils.removeClasses($btnConnectThiel, 'hidden');
